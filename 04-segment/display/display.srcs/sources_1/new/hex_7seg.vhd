...
entity hex_7seg is
  port (
    ...
    hex_i   : in    std_logic_vector(3 downto 0); --! Binary representation of one hexadecimal symbol
    seg_o   : out   std_logic_vector(6 downto 0)  --! Seven active-low segments in the order: a, b, ..., g
  );
end entity hex_7seg;
...
begin
  ...
  p_7seg_decoder : process (blank, hex_i) is
